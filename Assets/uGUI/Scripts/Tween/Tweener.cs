...
namespace uTools
{
    public abstract class Tweener : MonoBehaviour
    {
		...
		[System.Serializable]
		public class TweenEndEvent : UnityEvent { }
		[SerializeField]
		private TweenEndEvent _onFinished = new TweenEndEvent();
		public TweenEndEvent onFinished
		{
		...
		public void RemoveAllOnFinished() { onFinished.RemoveAllListeners(); }
